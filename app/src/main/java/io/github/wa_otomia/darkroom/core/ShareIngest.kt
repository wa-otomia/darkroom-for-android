...
/**
 * Intent and [android.content.ContentResolver.getType] MIME values are hints.
 * Accept missing types and typical gallery wildcards (`image/*`, `image/jpg`);
 * [io.github.wa_otomia.darkroom.data.catalog.CatalogRepository.ingestBytes]
 * still transcodes or errors on non-images.
 */
