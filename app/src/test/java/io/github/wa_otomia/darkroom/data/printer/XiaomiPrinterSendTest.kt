...
import io.github.wa_otomia.darkroom.core.INTERACTIVE_RESPONSE
...
import io.github.wa_otomia.darkroom.core.readU32LE
...
class XiaomiPrinterSendTest {
    ...
    private fun splitFrames(blob: ByteArray): List<ByteArray> {
        ...
        while (off < blob.size) {
            ...
            val bodyLen = io.github.wa_otomia.darkroom.core.bodyLengthFromAttr(attr)
            val len = 22 + bodyLen
